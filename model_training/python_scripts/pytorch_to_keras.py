...
#tf.saved_model.save(model, tensorflow_loc, signatures=concrete_function, save_format='h5')
tf.keras.models.save_model(model, tensorflow_loc, signatures=concrete_function, save_format='h5')